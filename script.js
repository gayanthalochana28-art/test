 // ============================================================
        // COMPLETE JAVASCRIPT with Google Sheets Notice Board
        // ============================================================
        ...
        // ============================================================
        // GOOGLE SHEETS NOTICE BOARD (Separate Sheet or same? Using same but can be changed)
        // TUTORIAL: 
        // 1. Create a Google Sheet with columns: Timestamp, Notice, Active
        // 2. Publish to web as CSV (File → Share → Publish to web → CSV)
        // 3. Replace the URL below with your published CSV URL
        // 4. The notice board will display all notices where Active = TRUE/YES
        // 5. You can also post notices manually using the input field (they will only appear locally)
        // ============================================================
        // 🔴 Replace this URL with your published Google Sheet CSV for notices
        ...
        // ============================================================
        // GOOGLE SHEETS NOTIFICATION FETCH (Top Bar)
        // ============================================================
        ...
        async function fetchGoogleSheetsNotices() {
            ...
            try {
                ...
                let html = '';
                let count = 0;
                for (let i = 1; i < lines.length && count < 20; i++) { // max 20 notices
                    const cols = lines[i].split(',').map(c => c.trim().replace(/^"|"$/g, ''));
                    if (cols.length >= 3) {
        ...
        function addLocalNotice(text) {
            ...
            div.innerHTML = `
                    ...
                    `;
            // Insert at top, keep only last 10
        ...
        console.log('🔗 Tutorial: Google Sheets Notice Board setup in code comments.');
